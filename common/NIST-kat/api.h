...
// #define CRYPTO_BYTES ((K + 7) / 8 + BIN_K_WEIGHT_N_BYTES + 4)
//  CRYPTO_BYTES = ceil(log(binomial(K, N-WEIGHT), 2)/8) +
//  ceil((K-(N-WEIGHT))/8) + 4
// #define CRYPTO_BYTES (826 + SALT_SIZE)
#define CRYPTO_BYTES (790 + SALT_SIZE)
// #define CRYPTO_BYTES ((K + 4) / 5)

// Change the algorithm name
#ifdef NIST192
#define CRYPTO_ALGNAME "WAVE-192"
#elifdef NIST256
#define CRYPTO_ALGNAME "WAVE-256"
#else
#define CRYPTO_ALGNAME "WAVE-128"
#endif
